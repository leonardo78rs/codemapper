...
If Not lAnimado Then
  wOcorr.Cells(6, 2) = cFile ' Colocar em tela o fonte que est† buscando so no final 
  wOcorr.Cells(7, 2) = numfontes
End If
...
For nBuscas = 6 To 46
    ...
    If cBusca <> Empty Then   ' PERGUNTAR SE NAO ê A PRIMARIA
     ...
     Else
        ...
        If nEmBranco > 3 Then
           nBuscas = 46        'Foráa a sair do loop
        End If
     End If
...
MsgBox ("- Tem que copiar todos arquivos para uma pasta" + Chr(10) + _
        ...
        "- N∆o procura em linhas comentadas com // , e */ /* quando estiver na mesma linha" + Chr(10) + _
        "- PorÇm ainda n∆o desconsidera bloco de c¢digo comentado */ e /* em linhas diferentes " + Chr(10) + Chr(10) + _
