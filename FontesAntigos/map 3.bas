...
na = 1   'retorno da outra funcao e linha inicial da planilha fontes 
...
'--------------------------------------------------------------------------
Function ImportTxtFile(cPath As String, cFile As String, cBusca As String,  a As Double) As Double
