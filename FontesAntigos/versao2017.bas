...
a = ImportTxtFile(cPath, cFile, cBusca, 1)
a = ImportTxtFile(cPath, cFile, "function", 2)
a = ExtraiNomesFunc()
...
Function ImportTxtFile(cPath As String, cFile As String, cBusca As String, nPlanilha As Integer) As Boolean
...
For lin1 = 1 To 300
    For lin2 = 1 To 300
        If wPlan1.Cells(lin1, 2) > wPlan2.Cells(lin2, 2) And wPlan1.Cells(lin1, 2) < wPlan2.Cells(lin2 + 1, 2) Then
